...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs()
          .withKP(12) // used to be 10
          .withKI(0)
          .withKD(0)
          .withKS(0) // From sysid routine
          .withKV(0.46318) // From sysid routine
          .withKA(0)
          .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
  // When using closed-loop control, the drive motor uses the control
  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
  private static final Slot0Configs steerGains =
      new Slot0Configs().withKP(4000).withKI(0).withKD(50).withKS(0).withKV(0).withKA(0);
  ...
  private static final Pigeon2Configuration pigeonConfigs =
      new Pigeon2Configuration()
          .withMountPose(new MountPoseConfigs().withMountPoseYaw(Angle.ofBaseUnits(0, Degrees)));
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.69); // 4.69
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.481689453125);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.19384765625);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(0.029296875);
