...
public class DriveCommands {
  ...
  public static Command joystickDriveAtAngle(
      ...
      DoubleSupplier ySupplier,
      DoubleSupplier omegaSupplier,
      BooleanSupplier setOrientation) {
    ...
    return Commands.run(
            () -> {
              ...
              if (setOrientation.getAsBoolean()) {
                angleController.setGoal(
                    angleController.getSetpoint().position + omegaSupplier.getAsDouble() * 0.02);
              }
  ...
  public static Command driveChassisSpeeds(Drive drive, Supplier<ChassisSpeeds> speeds) {
