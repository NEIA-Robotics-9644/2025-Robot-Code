...
public class FieldConstants {
  ...
  public static class Barge {
    public static final List<Pose2d> align =
        Arrays.asList(
            new Pose2d(
                fieldLength / 2 + Units.inchesToMeters(40), fieldWidth / 2, Rotation2d.kZero),
            new Pose2d(
                fieldLength / 2 - Units.inchesToMeters(40), fieldWidth / 2, Rotation2d.k180deg));
    ...
    static {
      ...
      for (int face = 0; face < centerFaces.length; face++) {
        ...
        for (var level : ReefHeight.values()) {
          ...
          if (face < 6) {
            poseDirection = new Pose2d(centerOfReef, centerFaces[face].getRotation());
          } else {
            poseDirection =
                new Pose2d(
                    centerOfReef.rotateAround(fieldCenter, Rotation2d.k180deg),
